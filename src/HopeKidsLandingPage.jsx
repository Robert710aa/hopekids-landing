...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-28`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /*
         * Hero art: <img> + contain. Desktop scaleY(1.45); mobile only scaleY(1.9).
         */
        ...
        @media (max-width: 639px) {
          .hopekids-hero-panel-art {
            -webkit-transform: translateZ(0) scaleY(1.9);
            transform: translateZ(0) scaleY(1.9);
          }
        }
