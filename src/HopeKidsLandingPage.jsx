...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-15`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Hero panel art: square illustration — contain + scaleY(5%) for extra vertical fill without widening. */
