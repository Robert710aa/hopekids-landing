...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-21`;
  ...
  return (
    <>
      ...
      <style>{`
         ...
         * scaleY was 1.13 — too subtle on phone; 1.22 reads clearly; dial back if you prefer subtler.
         */
        .hopekids-hero-panel-art {
          ...
          -webkit-transform: translateZ(0) scaleY(1.22);
          transform: translateZ(0) scaleY(1.22);
