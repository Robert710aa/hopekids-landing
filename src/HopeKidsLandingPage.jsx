...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-14`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Hero panel art: square illustration — contain keeps full composition; scaleY(~2%) adds a touch of vertical fill. */
