...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-13`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Hero panel art: square illustration — contain keeps full composition visible (letterbox via panel bg). */
