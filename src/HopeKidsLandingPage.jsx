...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-5`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Mobile: ~half the visual scale vs cover — 50% width + auto height, centered; panel bg fills letterbox. */
