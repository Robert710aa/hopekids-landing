...
const HERO_ILLUSTRATION_BG_URL = `${HERO_ILLUSTRATION_SRC}?v=hk-panel-bg-39`;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /*
         * Hero art: sm+ uses cover. Mobile: contain + scale(1.16, 2.75).
         */
        ...
        @media (max-width: 639px) {
          .hopekids-hero-panel-art {
            ...
            -webkit-transform: translateZ(0) scale(1.16, 2.75);
            transform: translateZ(0) scale(1.16, 2.75);
